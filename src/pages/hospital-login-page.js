...
import HospitalRegistrationFormContai from "../components/hospital-registration-form-contai";
...
const HospitalLoginPage = () => {
  ...
  return (
    <div className="w-full relative [background:linear-gradient(180deg,_#5811b0,_#000_36.4%)] h-[67.5rem] overflow-hidden text-left text-[4rem] font-electrolize">
      ...
      <HospitalRegistrationFormContai
        entityName="Hospital Name"
        identifierText="Registration Number"
        hospitalDepartmentName="Departments"
        onButtonmuicontainedTextContainerClick={
          onButtonmuicontainedTextContainerClick
        }
      />
      ...
      <img
        className="absolute top-[26.5rem] left-[5.313rem] w-[40.313rem] h-[30.688rem]"
        alt=""
        src="/group-4.svg"
      />
    </div>
